...
options! {
    ...
    cgu_opt_levels: Option<PathBuf> = (None, parse_opt_pathbuf, [UNTRACKED],
    ...
    fn_opt_levels: Option<PathBuf> = (None, parse_opt_pathbuf, [UNTRACKED],
        "path to a file mapping function symbols to optimization levels (format: `fn_name O3|O2|Os|Oz` per line)"),
    fn_opt_level_default: String = ("Oz".to_string(), parse_string, [UNTRACKED],
        "default optimization level for functions not listed in `-Z fn-opt-levels` (O3|O2|Os|Oz; default: Oz)"),
