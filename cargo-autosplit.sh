...
# The compiler uses PGO profile data to identify cold functions and marks
# them with MinSize attribute, making LLVM optimize them for size within
# the O3 pipeline. Hot functions get full O3 optimization.
echo "=== [cargo-autosplit] Phase 2 — hot-cold-split build (hot=O3, cold=Oz) ===" >&2
